defmodule OurHomeWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: OurHomeWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/our_home_web/templates",
        namespace: OurHomeWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {OurHomeWeb.LayoutView, "live.html"}
